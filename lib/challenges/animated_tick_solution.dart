...
class AnimatedTickSolution extends StatefulWidget {
  const AnimatedTickSolution({Key? key}) : super(key: key);

  static const title = 'Animated Tick Solution';

  @override
  State<AnimatedTickSolution> createState() => _AnimatedTickSolutionState();
}

class _AnimatedTickSolutionState extends State<AnimatedTickSolution>
